...
This document explains how conventional commit types trigger automated releases via release-please in the edda project.

## Overview

The edda project uses **release-please** for automated versioning and releases. Not all commit types trigger releases - understanding which commits create new versions is critical for proper release management.
