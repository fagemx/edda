...
`crates/edda-cli/src/main.rs:508-513#With --json, exactly one object is printed to stdout:`):
...
`crates/edda-cli/src/main.rs:306-311#Status {`, dispatched at `crates/edda-cli/src/main.rs#Command::Status { json } =>`):
