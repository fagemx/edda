...
#
# The merge step that should call this does not exist yet — #762 owns it, and
# `scripts/pr-review-watch.sh` never merges by design. There it is one line.
# Until then this runs by hand after a merge.
#
