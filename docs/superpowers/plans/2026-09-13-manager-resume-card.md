# Native continuity workbench integration

1. Inventory native continuity, Pi compose/prepare/brief and task prepare. Reuse
   native context storage, repository identity, digest checks and restore warnings.
...
5. Freeze SHA, run package gates and exact-head CI, obtain independent qualified
   review, merge under R6, and upgrade 4390 with a pinned native executable.
