...
| [`guides/`](./guides/) | Using Edda with [Claude Code](./guides/claude-code.md), [MCP](./guides/mcp.md), [multi-agent setups](./guides/multi-agent.md), and [OpenClaw](./guides/openclaw.md) — plus [Edda from the agent's seat](./guides/for-agents.md), field notes written by an agent that uses edda daily |
